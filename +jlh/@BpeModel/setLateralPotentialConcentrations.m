function obj = setLateralPotentialConcentrations(obj)
...
%     c0Term =  prepTerm('c_bulk_id/c_ref*exp(-z_id*phi0)','c_bulk_id','z_id',obj.c_bulk_id,obj.z_id); % initial concentration distribution
    ...
    obj.BulkConcentrationsBC.selection.named('geom_laterlBoundary'); % fixed bulk concentration distribution according do Boltzmann factor
