function obj = update2dParametricPlots(obj,dset,plotDset)
...
%     fileNameTemplate = [fullProjectPath,'\\%s_%s.png'];
    ...
    solSubFolder = [fullProjectPath,'\',plotDset];
    if( ~exist( solSubFolder,'dir') )
        mkdir(solSubFolder);
    end
    
    parametric2dSubFolder = [solSubFolder,'\parametric2d'];
    if( ~exist( parametric2dSubFolder,'dir') )
        mkdir(parametric2dSubFolder);
    end
...
%         mkdir(dsetSubFolder);
%     end
%     plotSubFolder = [dsetSubFolder,'\plot2d',];
...
%     obj.m.result.export('plotExporter2d').set('pngfilename', 'G:\johnny\matlab\2016_02_projects\dat\2016_02_17_17_06_56_sample_project\exportTest.png');
    ...
    obj.m.result.export('plotExporter2d').set('zoomextents', 'on'); % off
...
%     m.m.sol('sol1').feature('s1').feature('pDef').getStringArray('plistarr')
    for j = 1:nRuns
        parameterSuffix = '';
        for k = 1:nParameters
            parameterSuffix = ['_',parameterNames{k},'_',num2str(parameterValues(j,k)),parameterSuffix];
        end
%         fileNameTemplate = [fullProjectPath,'\\%s',parameterSuffix,'.png'];
        pathTemplate = strrep(parametric2dSubFolder,'\','\\');
        fileNameTemplate = [pathTemplate,'\\%s',parameterSuffix,'.png'];
                

    %% potential plots
%         obj.m.result('phiSurfacePlotGroup').set('looplevel', {'4' '2'});
        obj.m.result('phiSurfacePlotGroup').set('data',dset);
        obj.m.result('phiSurfacePlotGroup').set('solnum',j);
        ...
        obj.m.result('phiContourPlotGroup').set('solnum',j);
        ...
        obj.m.result('phiStreamlinePlotGroup').set('solnum',j);
    ...
    %     obj.m.result('phiStreamlinePlotGroup').feature('phiStreamlinePlot').set('mdensity', '15');
        ...
        obj.m.result('phiArrowSurfacePlotGroup').set('solnum',j);
        ...
        obj.m.result('phiArrowLinePlotGroup').set('solnum',j);
    ...
    %     obj.m.result('phiArrowLinePlotGroup').feature('phiArrowLinePlot').set('wireframecolor', 'none');
        ...
        for i=1:obj.numberOfSpecies
            ...
            % species flux N    
            fileNameTemplate = [pathTemplate,'\\%s_',obj.c_id{i},parameterSuffix,'.png'];

            obj.m.result('nStreamlinePlotGroup').set('data',dset);
            obj.m.result('nStreamlinePlotGroup').set('solnum',j);
    ...
    %         obj.m.result('nStreamlinePlotGroup').feature('nStreamlinePlot').set('mdensity', '10');
            ...
            obj.m.result('nArrowSurfacePlotGroup').set('solnum',j);
            ...
            obj.m.result('nArrowLinePlotGroup').set('solnum',j);
            ...
            obj.m.result('cSurfacePlotGroup').set('solnum',j);
        ...
        %     model.result('pg7').feature('con1').set('unit', '');
            ...
            obj.m.result('cContourPlotGroup').set('solnum',j);
            ...
            obj.m.result('cStreamlinePlotGroup').set('solnum',j);
    ...
    %         obj.m.result('cStreamlinePlotGroup').feature('cStreamlinePlot').set('mdensity', '10');
            ...
            obj.m.result('cArrowSurfacePlotGroup').set('solnum',j);
            ...
            obj.m.result('cArrowLinePlotGroup').set('solnum',j);
    ...
    %         obj.m.result('cArrowLinePlotGroup').feature('cArrowLinePlot').set('wireframecolor', 'none');
        ...
        obj.m.result('iStreamlinePlotGroup').set('solnum',j);
    ...
    %     obj.m.result('iStreamlinePlotGroup').feature('iStreamlinePlot').set('mdensity', '15');
        ...
        obj.m.result('iArrowSurfacePlotGroup').set('solnum',j);
        ...
        obj.m.result('iArrowLinePlotGroup').set('solnum',j);
        ...
        obj.m.result('kappaContourPlotGroup').set('solnum',j);
        ...
        obj.m.result('kappaSurfacePlotGroup').set('solnum',j);
    ...
    %% mesh plot
    fileNameTemplate = [pathTemplate,'\\%s.png'];
