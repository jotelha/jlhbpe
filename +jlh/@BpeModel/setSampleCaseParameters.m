function obj = setSampleCaseParameters(obj)
...
%     molarConcentrationFe = numberConcentrationFe / constants.AvogadroConstant;
    ...
    obj.customParameters.cFe = 1; %absorbed into rate constant
    % obj.cFe2p = 0; % assume constant zero concentration of dissolved ion Fe2+ everywhere
    obj.customParameters.cH2O = 55560; % mol/m^3
    ...
    obj.customParameters.cH3Op   = cH3Op_bulk;
    obj.customParameters.cOHm    = cOHm_bulk;
    cFe2p   = cFe2p_bulk;
...
%     i = i+1;
    ...
    obj.reactions{i}.cOx                        = obj.customParameters.cO2*obj.customParameters.cH3Op; % bulk concentrations
...
%     obj.reactions{i}.reductantConcentrations{1} = '0';
    obj.reactions{i}.cR                         = obj.customParameters.cH2O;
...
%     obj.reactions{i}.flux                       = [0,4,0,0,0]; % outward flux of H3Op with cathodic current 
    ...
    obj.reactions{i}.cOx                        = obj.customParameters.cH3Op; % bulk concentration of hydrogen ions
    obj.reactions{i}.nuOxidants{1}              = -2;

    obj.reactions{i}.reductants{1}              = 'H2';
    obj.reactions{i}.reductantConcentrations{1} = 'cH2';
    obj.reactions{i}.cR                         = obj.customParameters.cH2; % zero
    obj.reactions{i}.nuReductants{1}            = 1;
