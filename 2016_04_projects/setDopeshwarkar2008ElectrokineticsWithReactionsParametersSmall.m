...
m.epsilon     = 0.1; % relation Debye length : simulation domain, lambdaD / L
...
% m.customParameters.cH2O = cH2O; % mol/m^3

%% Acidic Oxygen Reduction, balance to anodic oxygen evolution
i = 0;
i = i+1;
m.reactions{i}.name                       = 'AcidicOxygenReduction';
...
% m.reactions{i}.cR = cH2O;
m.reactions{i}.cR                         = 0; % assume only one direction, as Krawiec
m.reactions{i}.nuReductants{1}            = 2; % when considering H+, or 6, with h3O+
