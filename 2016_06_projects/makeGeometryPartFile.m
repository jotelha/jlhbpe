...
model.geom('simple1dGeometry').feature('simple1dGeometryPartInstance').setEntry('inputexpr', 'L', 'L');
...
model.geom('simpleBulkGeometryWithMeshingEntities').feature('pt1').setIndex('p', '-Wbpe/2-lambdaD', 0, 0);
...
model.geom('simpleBulkGeometryWithMeshingEntities').feature('pt2').setIndex('p', 'Wbpe/2-lambdaD', 0, 0);
...
model.geom('simpleBulkGeometryWithMeshingEntities').feature('pt3').setIndex('p', '-Wbpe/2+lambdaD', 0, 0);
...
model.geom('simpleBulkGeometryWithMeshingEntities').feature('pt4').setIndex('p', '+Wbpe/2+lambdaD', 0, 0);
...
model.geom('simpleBulkGeometryWithMeshingEntities').feature('pt5').setIndex('p', 'lambdaD', 1, 0);
...
model.geom('simpleBulkGeometryWithMeshingEntities').feature('pt6').setIndex('p', 'lambdaD', 1, 0);
...
model.geom('simpleDdlGeometryWithMeshingEntities').feature('pt1').setIndex('p', '-Wbpe/2-lambdaD', 0, 0);
...
model.geom('simpleDdlGeometryWithMeshingEntities').feature('pt2').setIndex('p', '-Wbpe/2-lambdaD', 0, 0);
...
model.geom('simpleDdlGeometryWithMeshingEntities').feature('pt3').setIndex('p', 'Wbpe/2-lambdaD', 0, 0);
...
model.geom('simpleDdlGeometryWithMeshingEntities').feature('pt4').setIndex('p', 'Wbpe/2-lambdaD', 0, 0);
...
model.geom('simpleDdlGeometryWithMeshingEntities').feature('pt5').setIndex('p', '-Wbpe/2+lambdaD', 0, 0);
...
model.geom('simpleDdlGeometryWithMeshingEntities').feature('pt6').setIndex('p', '-Wbpe/2+lambdaD', 0, 0);
...
model.geom('simpleDdlGeometryWithMeshingEntities').feature('pt7').setIndex('p', '+Wbpe/2+lambdaD', 0, 0);
...
model.geom('simpleDdlGeometryWithMeshingEntities').feature('pt8').setIndex('p', '+Wbpe/2+lambdaD', 0, 0);
...
model.geom('simpleDdlGeometryWithMeshingEntities').feature('pol1').set('x', '-Wbpe/2-lambdaD,-Wbpe/2-lambdaD');
...
model.geom('simpleDdlGeometryWithMeshingEntities').feature('pol2').set('x', 'Wbpe/2-lambdaD,Wbpe/2-lambdaD');
...
model.geom('simpleDdlGeometryWithMeshingEntities').feature('pol3').set('x', '-Wbpe/2+lambdaD,-Wbpe/2+lambdaD');
...
model.geom('simpleDdlGeometryWithMeshingEntities').feature('pol4').set('x', 'Wbpe/2+lambdaD,Wbpe/2+lambdaD');
...
model.mesh('simpleBulkGeometryRefinedMesh').feature('ftri1').feature('size1').set('hmax', 'lambdaD'); % maximum element width at bpe surface
...
model.mesh('simpleDdlGeometryRefinedMesh').feature('edg3').feature('size2').set('hmax', sprintf('%e*L',a_zeta));
...
model.mesh('simpleDdlGeometryRefinedMesh').feature('edg3').feature('size1').set('hmax', 'lambdaD');
...
model.mesh('simpleDdlGeometryRefinedMesh').feature('edg4').feature('size1').set('hmax', sprintf('%e*L',a_zeta));
