...
% model.cpl('extrudeZetaPlaneToSurface').selection('srcvertex1').set(5); % order of vertex creation important
% % model.cpl('extrudeZetaPlaneToSurface').selection('srcvertex2').set(4);
% model.cpl('extrudeZetaPlaneToSurface').selection('srcvertex2').set(7);
% % model.cpl('extrudeZetaPlaneToSurface').selection('dstvertex1').set(1);
% model.cpl('extrudeZetaPlaneToSurface').selection('dstvertex1').set(2);
% % model.cpl('extrudeZetaPlaneToSurface').selection('dstvertex2').set(3);
% model.cpl('extrudeZetaPlaneToSurface').selection('dstvertex2').set(4);
