...
i = 0;
i = i+1;
m.reactions{i}.name                       = 'DummyReaction';
m.reactions{i}.reaction                   = '0'; % simplified H3O+ + e- <=> 3/2 H2O
% % could be as well O2 + 4H+ + 4e- <=> 2H2O

    % % in anodic direction > 0:
m.reactions{i}.anodicCurrentTerm        = '0';
m.reactions{i}.cathodicCurrentTerm      = [];

m.reactions{i}.E0                         = 0;
m.reactions{i}.n                          = 1; 
m.reactions{i}.flux                       = [0,0,0,0,0]; % outward flux of H3Op with cathodic current 
